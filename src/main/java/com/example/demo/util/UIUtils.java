...
import com.example.demo.util.css.*;
...
public class UIUtils {
    ...
    public static final String COLUMN_WIDTH_2X = "480px";
    public static final String COLUMN_WIDTH_3X = "720px";
    ...
    public static String formatDate(LocalDate dateString) {
        return dateFormat.get().format(dateString);
    }
    ...
    public static FlexBoxLayout createPhoneLayout() {
    ...
    public static boolean isAdmin(){
        return UIUtils.getLoggedInUser().equalsIgnoreCase(ADMIN);
    }
}
